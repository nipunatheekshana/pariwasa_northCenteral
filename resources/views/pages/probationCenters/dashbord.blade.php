                ...
                <form class="needs-validation" id="probation_center_form">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control"  name="telepone_no"   id="tp_no" placeholder="0XX XXX XX XX" pattern="[1-9]{1}[0-9]{9}" maxlength="10" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                            <div class="valid-feedback">
                                Looks good!
                            </div>
                        </div>
...
<script src="{{ url('assets/js/custom/probationCenters/dashbord.js') }}?random=<?php echo uniqid(); ?>"></script>
