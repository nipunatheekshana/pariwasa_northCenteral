            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="tblvendor" class="table table-striped table-bordered Date display nowrap">
                            <thead>
                                <tr>
                                    <th class="thid"> #</th>
...
@section('script')
    ...
    <script src="{{ url('assets/js/custom/probationCenterCatagory.js') }}?random=<?php echo uniqid(); ?>"></script>
@endsection
