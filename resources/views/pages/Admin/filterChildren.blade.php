                ...
                <div class="card-body">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-4 mb-3">
                            <label class="switch"><input type="checkbox" id="cbxpbOffice"><span
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-4 mb-3">
                            <label class="switch"><input type="checkbox" id="cbxpbCenter"><span
                                    class="slider round"></span></label>
                            <div class="valid-feedback">
                                Looks good!
                            </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-4 mb-3">
                            <label class="switch"><input type="checkbox" id="cbxGender"><span
                                    class="slider round"></span></label>
                            <div class="valid-feedback">
                                Looks good!
                            </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="tblChildren" class="table table-striped table-bordered Date display nowrap">
                            <thead>
                                <tr>
                                    <th class="thId">#</th>
