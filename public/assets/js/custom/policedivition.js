...
function loadpoliceDivitions(){
    $.ajax({
        type: 'GET',
        url: '/policeDivitions/loadpoliceDivitions',
        success: function(response){
            console.log(response.result)
            if (response.success) {
...
function edit(id) {
    ...
    $.ajax({
        type: 'GET',
        url: '/policeDivitions/loadpoliceDivitions/'+id,
        success: function(response){
